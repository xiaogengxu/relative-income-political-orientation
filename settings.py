...
SESSION_CONFIGS = [
    ...
    # ),
    dict(
        name='Relative_income_Beta',
        display_name='Relative income Beta',
        num_demo_participants=3,
        app_sequence=['consentform','preferred_info','beliefs','stimuli','job_salary','just_world',
                      'social_pref','political_pref','competitiveness',
                      'incentivized_tasks','summary'],
    ),
]
